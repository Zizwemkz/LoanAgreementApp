...
namespace LoanAgreementAPI.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "TbAgreementType",
                columns: table => new
                {
                    AgreementTypeId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AgreementName = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbAgreementType", x => x.AgreementTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbCustomerLoan", x => x.LoanId);
                    table.ForeignKey(
                        name: "FK_TbCustomerLoan_TbAgreementType_AgreementId",
                        column: x => x.AgreementId,
                        principalTable: "TbAgreementType",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TbCustomerLoan_AgreementId",
